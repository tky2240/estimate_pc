...
def run(csv_path, json_path):
    ...
    with open(csv_path) as f:
        ...
        for genre in reader:
            ...
            try:
                item_count = int(
                    soup.select_one("div.alignL > span.number")
                    .contents[0]
                    .text.replace(",", "")
                )
            except:
            ...
            item_tables = [
                soup.select_one(
                    "#spec_result > div.alignC > form > table > tr:nth-child(3) > td > table"
                )
            ]
            ...
            for i in range(2, page_count + 1):
                ...
                soup = BeautifulSoup(response.text, "html.parser")
                item_tables.append(
                    soup.select_one("table.alignC.tblBorderGray02.mTop5")
                )

            if genre["name"] == "cpu":
                item_data_dictionary[genre["name"]] = update_cpu_information(
                    item_tables
                )
            elif genre["name"] == "cpu_cooler":
                item_data_dictionary[genre["name"]] = update_cpu_cooler_information(
                    item_tables
                )
                ...
                item_data_dictionary[genre["name"]] = update_memory_information(
                    item_tables
                )
            elif genre["name"] == "gpu":
                item_data_dictionary[genre["name"]] = update_gpu_information(
                    item_tables
                )
            elif genre["name"] == "ssd":
                item_data_dictionary[genre["name"]] = update_ssd_information(
                    item_tables
                )
            elif genre["name"] == "hdd":
                item_data_dictionary[genre["name"]] = update_hdd_information(
                    item_tables
                )
            elif genre["name"] == "case":
                item_data_dictionary[genre["name"]] = update_case_information(
                    item_tables
                )
        ...
        for table_row in table_rows:
            try:
                ...
                cpu_data_dictionary = {
                    ...
                    "core_count": int(
                        re.findall(r"(\d+)コア", table_data[11].text.strip())[0]
                    ),
                    "thread_count": (
                        int(re.findall(r"(\d+)コア", table_data[11].text.strip())[0])
                        if table_data[15].text.strip() == ""
                        else int(table_data[15].text)
                    ),
                    "tdp": (
                        None
                        if table_data[12].text.strip() == ""
                        else int(re.findall(r"(\d+)W", table_data[12].text.strip())[0])
                    ),
                    "base_clock": float(
                        re.findall(r"(\d+\.\d+|\d+)GHz", table_data[13].text)[0]
                    ),
                    "boost_clock": (
                        None
                        if table_data[14].text.strip() == ""
                        else float(
                            re.findall(r"(\d+\.\d+|\d+)GHz", table_data[14].text)[0]
                        )
                    ),
                    "graphics": table_data[19].text.strip(),
                    "release_date": (
                        None
                        if table_data[21].text.strip() == ""
                        else (
                            datetime.datetime.strptime(
                                re.sub(r"\s", "", table_data[21].text), "%Y年%m月%d日"
                            ).date()
                            if re.match(
                                r"\d+年\d+月\d+日",
                                re.sub(r"\s", "", table_data[21].text),
                            )
                            is not None
            ...
            try:
                ...
                cpu_cooler_data_dictionary = {
                    ...
                    "max_tdp": (
                        ...
                        else int(re.findall(r"(\d+)W", table_data[19].text.strip())[0])
                    ),
                    "width": (
                        None
                        if table_data[21].text.strip() == ""
                    ...
                    "release_date": (
                        None
                        if table_data[24].text.strip() == ""
                        else (
                            datetime.datetime.strptime(
                                re.sub(r"\s", "", table_data[24].text), "%Y年%m月%d日"
                            ).date()
                            if re.match(
                                r"\d+年\d+月\d+日",
                                re.sub(r"\s", "", table_data[24].text),
                            )
                            is not None
                            else datetime.datetime.strptime(
                                re.findall(
                ...
                if not table_data[8].text.strip() == "":
                    ...
                    for socket_name_line in socket_name_lines:
                        ...
                        intel_socket_names += [
                            "LGA" + socket_name
                            for socket_name in socket_name_line.strip().split("/")
                        ]
                amd_socket_names = []
                ...
                print(traceback.format_exc())
                continue
            cpu_cooler_data_dictionary["cpu_cooler_sockets"] = (
                intel_socket_names + amd_socket_names
            )
            ...
            try:
                ...
                motherboard_data_dictionary = {
                    ...
                    "max_memory_capacity": int(
                        re.findall(r"(\d+)GB", table_data[14].text.strip())[0]
                    ),
                    "pci_slot_count": (
                        0
                        if table_data[19].text.strip() == ""
                        else int(re.findall(r"(\d+)本", table_data[19].text.strip())[0])
                    ),
                    "pcie_x16_slot_count": (
                        0
                        if table_data[15].text.strip() == ""
                            ...
                            re.findall(
                                r"(\d+)x PCI Express", table_data[15].text.strip()
                            )[0]
                        )
                    ),
                    "pcie_x8_slot_count": (
                        0
                        if table_data[16].text.strip() == ""
                        else int(
                            re.findall(
                                r"(\d+)x PCI Express", table_data[16].text.strip()
                            )[0]
                        )
                    ),
                    "pcie_x4_slot_count": (
                        0
                        if table_data[17].text.strip() == ""
                        else int(
                            re.findall(
                                r"(\d+)x PCI Express", table_data[17].text.strip()
                            )[0]
                        )
                    ),
                    "pcie_x1_slot_count": (
                        0
                        if table_data[18].text.strip() == ""
                        else int(
                            re.findall(
                                r"(\d+)x PCI Express", table_data[18].text.strip()
                            )[0]
                        )
                    ),
                    "sata_connector_count": (
                        0
                        if table_data[20].text.strip() == ""
                        else int(re.findall(r"(\d+)本", table_data[20].text.strip())[0])
                    ),
                    "release_date": (
                        None
            ...
            try:
                ...
                memory_data_dictionary = {
                    ...
                    "capacity_per_module": int(
                        re.findall(r"(\d+)GB", table_data[8].text.strip())[0]
                    ),
                    "module_count": int(
                        re.findall(r"(\d+)枚", table_data[9].text.strip())[0]
                    ),
        ...
        for table_row in table_rows:
            try:
                ...
                gpu_data_dictionary = {
                    ...
                    "gpu_memory_type": table_data[11]
                    .get_text(",")
                    .split(",")[0]
                    .strip(),
                    "gpu_memory_capacity": int(
                        re.findall(
                            r"(\d+)GB",
                            table_data[11].get_text(",").split(",")[1].strip(),
                        )[0]
                    ),
                    "gpu_memory_bus_width": (
                        None
                        if re.match(r"(\d+)bit", table_data[12].text.strip()) is None
                        else int(
                            re.findall(r"(\d+)bit", table_data[12].text.strip())[0]
                        )
                    ),
                    "gpu_memory_clock": (
                        None
                        if re.match(r"(\d+|\d+\.\d+)Gbps", table_data[13].text.strip())
                        is None
                        else float(
                            re.findall(
                                r"(\d+|\d+\.\d+)Gbps", table_data[13].text.strip()
                            )[0]
                        )
                    ),
                    ...
                    "tdp": (
                        None
                        if re.match(r"(\d+)W", table_data[19].text.strip()) is None
                        else int(re.findall(r"(\d+)W", table_data[19].text.strip())[0])
                    ),
                    "hdmi_count": (
                        0
                        if re.match(r"(\d+)ポート", table_data[26].text.strip()) is None
                        else int(
                            re.findall(r"(\d+)ポート", table_data[26].text.strip())[0]
                        )
                    ),
                    "displayport_count": (
                        0
                        if re.match(r"(\d+)ポート", table_data[27].text.strip()) is None
                        else int(
                            re.findall(r"(\d+)ポート", table_data[27].text.strip())[0]
                        )
                    ),
                    "width": (
                        None
                        if table_data[28].text.strip() == ""
                        else float(
                            re.findall(
                                r"(\d+\.\d+|\d+)x(\d+\.\d+|\d+)x(\d+\.\d+|\d+)",
                                table_data[28].text.strip(),
                            )[0][0]
                        )
                    ),
                    "height": (
                    ...
                    "release_date": (
                        None
                        if table_data[31].text.strip() == ""
                        else (
                            datetime.datetime.strptime(
                                re.sub(r"\s", "", table_data[31].text), "%Y年%m月%d日"
                            ).date()
                            if re.match(
                                r"\d+年\d+月\d+日",
                                re.sub(r"\s", "", table_data[31].text),
                            )
                            is not None
                            else datetime.datetime.strptime(
                                re.findall(
                ...
                ssd_data_dictionary = {
                    ...
                    "tbw": (
                        ...
                        if table_data[21].text.strip() == ""
                            ...
                            re.findall(r"(\d+)TBW", table_data[21].text.strip())[0]
                        )
                    ),
                    "release_date": (
                        None
                        if table_data[23].text.strip() == ""
                        else (
                            datetime.datetime.strptime(
                                re.sub(r"\s", "", table_data[23].text), "%Y年%m月%d日"
                            ).date()
                            if re.match(
                                r"\d+年\d+月\d+日",
                                re.sub(r"\s", "", table_data[23].text),
                            )
                            is not None
                            else datetime.datetime.strptime(
                                re.findall(
        ...
        for table_row in table_rows:
            try:
                ...
                hdd_data_dictionary = {
                    ...
                    .text.strip()[:100],
                    "capacity": (
                        int(re.findall(r"(\d+)GB", table_data[9].text.strip())[0])
                        if re.match(r"(\d+)GB", table_data[9].text.strip()) is not None
                        else int(re.findall(r"(\d+)TB", table_data[9].text.strip())[0])
                        * 1000
                    ),
                    "rpm": (
                        None
                        if table_data[10].text.strip() == ""
                        else int(
                            re.findall(r"(\d+)rpm", table_data[10].text.strip())[0]
                        )
                    ),
                    ...
                    "release_date": (
                        ...
                        if table_data[20].text.strip() == ""
                            ...
                            datetime.datetime.strptime(
                                re.sub(r"\s", "", table_data[20].text), "%Y年%m月%d日"
                            ).date()
                            if re.match(
                                r"\d+年\d+月\d+日",
                                re.sub(r"\s", "", table_data[20].text),
                            )
                            is not None
                            else datetime.datetime.strptime(
                                re.findall(
            ...
            try:
                ...
                case_data_dictionary = {
                    ...
                    "max_gpu_length": (
                        ...
                        if re.match(
                            r"(\d+)mm",
                            re.sub(r"[^0-9m]", "", table_data[9].text.strip()),
                        )
                        is None
                        else int(
                            re.findall(
                    ...
                    "max_cpu_cooler_height": (
                        ...
                        if re.match(
                            r"(\d+)mm",
                            re.sub(r"[^0-9m]", "", table_data[10].text.strip()),
                        )
                        is None
                        else int(
                            re.findall(
                    ...
                    "max_power_supply_size": (
                        None
                        if re.match(
                            r"(\d+)mm",
                            re.sub(r"[^0-9m]", "", table_data[11].text.strip()),
                        )
                        is None
                        else int(
                            re.findall(
                    ...
                    "slot_count": (
                        None
                        if re.match(r"(\d)", table_data[13].text.strip()) is None
                        else int(re.findall(r"(\d)", table_data[13].text.strip())[0])
                    ),
                    "drive_bay_information": table_data[14].get_text("\n").strip(),
                    "is_low_profile": table_data[18].text.strip() != "",
                    "weight": (
                        None
                        if table_data[20].text.strip() == ""
                        else float(
                            re.findall(
                                r"(\d+\.\d+|\d+)kg", table_data[20].text.strip()
                            )[0]
                        )
                    ),
                    "width": (
                    ...
                    "release_date": (
                        None
                        if table_data[25].text.strip() == ""
                        else (
                            datetime.datetime.strptime(
                                re.sub(r"\s", "", table_data[25].text), "%Y年%m月%d日"
                            ).date()
                            if re.match(
                                r"\d+年\d+月\d+日",
                                re.sub(r"\s", "", table_data[25].text),
                            )
                            is not None
                            else datetime.datetime.strptime(
                                re.findall(
                ...
                if not table_data[8].text.strip() == "":
                    motherboard_form_factors = table_data[8].get_text(",").split(",")
            except Exception as exception:
                print(f"error with {exception}")
                print(traceback.format_exc())
                print(table_row)
        ...
        for table_row in table_rows:
            try:
                ...
                power_supply_data_dictionary = {
                    ...
                    "capacity": int(
                        re.findall(r"(\d+)W", table_data[9].text.strip())[0]
                    ),
                    "eighty_plus_certification": table_data[15].text.strip(),
                    "cpu_connector_count": (
                        None
                        if re.match(r"x(\d)", table_data[20].text.strip()) is None
                        else len(re.findall(r"x\d", table_data[20].text.strip()))
                    ),
                    "six_pin_connector_count": (
                        None
                        if re.match(r"6ピンx(\d)", table_data[21].text.strip()) is None
                        else int(
                            re.findall(r"6ピンx(\d)", table_data[21].text.strip())[0]
                        )
                    ),
                    "eight_pin_connector_count": (
                        None
                        if re.match(r"6\+2ピンx(\d)", table_data[21].text.strip())
                        is None
                        else int(
                            re.findall(r"6\+2ピンx(\d)", table_data[21].text.strip())[0]
                        )
                    ),
                    "sata_connector_count": (
                        None
                        if re.match(r"(\d+)個", table_data[22].text.strip()) is None
                        else int(re.findall(r"(\d+)個", table_data[22].text.strip())[0])
                    ),
                    "peripheral_connector_count": (
                        None
                        if re.match(r"(\d+)個", table_data[23].text.strip()) is None
                        else int(re.findall(r"(\d+)個", table_data[23].text.strip())[0])
                    ),
                    "fdd_connector_count": (
                        None
                        if re.match(r"(\d+)個", table_data[24].text.strip()) is None
                        else int(re.findall(r"(\d+)個", table_data[24].text.strip())[0])
                    ),
                    "weight": (
                        None
                        if table_data[27].text.strip() == ""
                        else float(
                            re.findall(
                                r"(\d+\.\d+|\d+)kg", table_data[27].text.strip()
                            )[0]
                        )
                    ),
                    "width": (
                        None
                        if table_data[26].text.strip() == ""
                        else float(
                            re.findall(
                                r"(\d+\.\d+|\d+)x(\d+\.\d+|\d+)x(\d+\.\d+|\d+)",
                                table_data[26].text.strip(),
                            )[0][0]
                        )
                    ),
                    "height": (
                    ...
                    "release_date": (
                        ...
                        if table_data[29].text.strip() == ""
                            ...
                            datetime.datetime.strptime(
                                re.sub(r"\s", "", table_data[29].text), "%Y年%m月%d日"
                            ).date()
                            if re.match(
                                r"\d+年\d+月\d+日",
                                re.sub(r"\s", "", table_data[29].text),
                            )
                            is not None
                            else datetime.datetime.strptime(
                                re.findall(
...
def update_monitor_information(item_tables: List[Tag]):
    monitor_data_dictionaries = []
    for item_table in item_tables:
        table_rows = item_table.select("tr:not(.bgColor03.vt):not(.bgColor02)")
        for table_row in table_rows:
            try:
